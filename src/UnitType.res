...
Js.log(arityOfZero()) // this works because we've given the function a unit type.

Js.log(arityOfZero()) // the parenthesis isn't part of the fn call. see below

Js.log(arityOfZero()) // same thing
